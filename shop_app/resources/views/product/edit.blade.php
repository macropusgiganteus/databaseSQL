    ...
    <div class="form-wrap">
      ...
      <form action="{{action('ProductsController@update', $productCode)}}" method="POST">
        ...
        <div class="input-group">
          ...
          <input type="text" name="productCodeshow" id="productCode"  class="input-box" placeholder=""
        ...
        <div class="input-group">
          ...
          <input type="text" name="productScale" id="budget" class="input-box"  placeholder="X:X" value="{{$product->productScale}}">
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          ...
          <input type="text"  name="productDescription" id="budget"  class="input-box" placeholder="" value="{{$product->productDescription}}">
        </div>
        <div class="input-group">
          <label for="budget">Amount</label>
          <input type="number"  name="quantityInStock" id="budget"  class="input-box" placeholder="" value="{{$product->quantityInStock}}">
        </div>
        <div class="input-group">
            <label for="budget">Price</label>
            <input type="number" step="0.01" name="buyPrice" id="budget"  class="input-box" placeholder="" value="{{$product->buyPrice}}">
          </div>
        <div class="input-group">
            <label for="budget">MSRP</label>
            <input type="number" step="0.01" name="MSRP" id="budget"  class="input-box" placeholder="" value="{{$product->MSRP}}">
          </div>
